          ...
          <div className='servicesItem container'>
            <div className='item1 group'>
              ...
              <div className='item_overlay'>
                ...
                <a href='./contacts' className='item_link'>Book an Appointment</a>
              </div>
            ...
            <div className='item2 group'>
              ...
              <div className='item_overlay'>
                <p className='description'>Oil is the lifeblood of your engine. It reduces friction, lessens wear, provides lubrication, forms a seal between the pistons, rings and cylinder walls while helping to cool engine parts.</p>
                <a href='./contacts' className='item_link'>Book an Appointment</a>
              </div>
            ...
            <div className='item4 group'>
              ...
              <div className='item_overlay'>
                <p className='description'>Mag's-trained professionals can test your car battery and replace it if necessary with a battery from leading brands.</p>
                <a href='./contacts' className='item_link'>Book an Appointment</a>
              </div>
            ...
            <div className='item5 group'>
              ...
              <div className='item_overlay'>
                <p className='description'>Car AC systems have components that require love and attention to avoid drying out and cracking. The car heater also needs regular check-ups to make sure there are no leaky valves or blockages.</p>
                <a href='./contacts' className='item_link'>Book an Appointment</a>
              </div>
            ...
            <div className='moreServices'>
              <h3 className='moreServicesTitle'>MORE SERVICES</h3>
                <ul className='moreServicesList'>
                  <li><p>Automotive Collision Repair</p></li>
                  <li><p>Automotive Painting</p></li>
                  <li><p>Automotive Diagnosis</p></li>
                  <li><p>Rental Car Assistance</p></li>
                  <li><p>Mechanical and Body Work</p></li>
                  <li><p>24/7 Towing Service</p></li>
                  <li><p>Wheel Alignment</p></li>
                  <li><p>Brake Pads Replacement</p></li>
                  <li><p>Exhaust and Muffler Repair</p></li>
                </ul>
            </div>
